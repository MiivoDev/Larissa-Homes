...
function Link() {
  return (
    <div className="absolute h-[28px] left-0 top-0 w-[134.07px]" data-name="Link">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#2e5d82] text-[20px] top-[-1px] tracking-[0.0508px] whitespace-nowrap">Larisa Homes</p>
    </div>
  );
}
